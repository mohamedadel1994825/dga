      ...
      <div dir={currentLang === 'ar' ? 'rtl' : 'ltr'}>
        <div>
          <WebComponentErrorBoundary
            fallback={<div style={{ minHeight: '40px' }} />}
          >
        ...
        <div className='pt-[40px] px-[16px] md:px-[80px]'>
          <section className='mt-[24px]'>
            ...
            <p className='text-md-regular text-[#161616] mb-8'>
              ...
              portal followed with a call to action button and an image or an
              ...
              <div className='carousel-card carousel-double'>
                ...
                <DgaCarousel>
                  ...
                  <DgaCarouselItem>
                    ...
                    />
                    <p className='carousel-text'>
                      التبادل الطلابي والبرامج المشتركة
                    </p>
                  </DgaCarouselItem>
                  <DgaCarouselItem>
                    <Image
                    ...
                    />
                    <p className='carousel-text'>
                      البرامج الناشئة والتخصصات الجديدة
                    </p>
                  </DgaCarouselItem>
                </DgaCarousel>
              </div>
