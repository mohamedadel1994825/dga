  ...
  return (
    <div className="rounded-[16px] border border-[#D2D6DB] overflow-hidden bg-white flex flex-col h-full">
      <div className="relative w-full h-[196px]">
        <Image src={imageSrc} alt={title as string} fill className="object-cover" />
      </div>
    ...
    <section className="px-[16px] md:px-[80px] py-[24px]">
      <div className="grid grid-cols-1 lg:grid-cols-[308px_308px_1fr] gap-[24px] items-stretch">
        <SmallCard
          ...
          title={<Trans>Not just graduates.. In Imam University&apos;s medical college labs, we shape tomorrow&apos;s doctors with a national vision</Trans>}
          bullets={["", "", "", ""]}
        ...
        <SmallCard
          ...
          title={<Trans>A distinguished center at the Muslim World League endorses Imam University&apos;s achievements in paper and electronic publishing</Trans>}
          bullets={["", "", "", ""]}
          ...
          <div className="absolute inset-0 flex items-end p-[24px] lg:p-[32px]">
            <div className="text-right text-white max-w-[600px] ml-auto">
              <h2 className="text-[30px] leading-[38px] font-bold mb-[12px]">
                <Trans>When action transforms from a passing deed into an established value</Trans>
              </h2>
              <p className="text-[14px] leading-[22px] opacity-90">
                <Trans>While the stories of the past were told with passion, when ink and paper were the only window to knowledge; they were not just exchanged words...</Trans>
              </p>
