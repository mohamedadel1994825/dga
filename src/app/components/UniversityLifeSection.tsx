  ...
  return (
    <div className="rounded-[16px] border border-[#D2D6DB] overflow-hidden bg-white flex flex-col h-full">
      <div className="relative w-full h-[240px]">
        <Image src={imageSrc} alt={typeof title === 'string' ? title : ''} fill className="object-cover" />
      </div>
  ...
  const cards = [
    {
      ...
      title: <Trans>خلف كواليس الاحتفال.. فريق طلابي يروح وطنية واحدة يصنع ذكرى لا تُنسى في يوم التأسيس</Trans>,
      description: <Trans>عبر مبادرة جامعية تحمل اسم عهد، يجود مشاركة فعّالة في إحياء يوم التأسيس الذي ينبض بالحماس خلف كواليس الاحتفال... من تنسيق الفعاليات إلى تصميم العروض، كانت كل تفصيلة تحمل بصمة طلابية... فكيف تحوّلت روحة الجامعة إلى احتفالية طلابية السعودية؟</Trans>,
    },
    {
      imageSrc: "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?q=80&w=2070&auto=format&fit=crop",
      title: <Trans>ليست مجرد تسلية.. كيف حوّل الطلاب شغفهم الإلكتروني إلى صحة نفسية وإبداع وتوازن</Trans>,
      description: <Trans>من سباقات الإنسان الاقتصادية حيث تتصارع الأفكار بدلاً من قدراتهم، إلى فضاء هادئ منظّمة، في مبادرة LAG بالرياضيات الإلكترونية، جمعة اللعب إلى أبعد مختلف. كيف أصبحت نقاط قوة الداخلية وجزء من الداخلية. كيف أصبحت نقاط صحتنا النفسية... كيف حدث هذا؟</Trans>,
    },
    {
      imageSrc: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?q=80&w=2080&auto=format&fit=crop",
      title: <Trans>من فرشاتهم انطلقت قصص الوطن.. طلاب يروون حب المملكة بلوحات تنبض الفن محمد الجديد</Trans>,
      description: <Trans>لم تكن مجرد ألوان بل رسالة عميقة انطلقت بلوحات مثلج تنفذ يوسف أمام بوحات البصاء يحمل فرشاته ليحوّل لوحات من تاريخ المملكة إلى نوافذ على الفخر... فكيف كانت رحلته من الفكرة إلى اللوحة المكتوبة</Trans>,
    },
  ];
